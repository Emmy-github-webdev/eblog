@extends('layouts.app')
@section('title', 'The most visit blog site in the world')
...
<div class="home">
  ...
  <div class="row small-up-2 medium-up-4 large-up-5">
    ...
    <section class="display-breakingnews" data-token="{{ $token }}" id="breakingnews">
  ...
  <hr>
   ...
   <div class="row small-up-2 medium-up-3 large-up-5">
    ...
    <section class="display-healthnews" data-token="{{ $token }}" id="healthnews">
   ...
   <div class="row small-up-2 medium-up-4 large-up-5">
    ...
    <section class="display-lifestylenews" data-token="{{ $token }}" id="lifestylenews">
      <div class="row medium-up-2 large-up-4">
   ...
   <div class="row small-up-2 medium-up-4 large-up-5">
    ...
    <section class="display-technewsnews" data-token="{{ $token }}" id="technews">
      <div class="row medium-up-2 large-up-4">
  ...
  <div class="row small-up-2 medium-up-4 large-up-5">
    ...
    <section class="display-politics" data-token="{{ $token }}" id="politics">
      <div class="row medium-up-2 large-up-4">
  ...
  <div class="row small-up-2 medium-up-4 large-up-5">
    ...
    <section class="display-business" data-token="{{ $token }}" id="business">
      <div class="row medium-up-2 large-up-4">
  ...
  <div class="row small-up-2 medium-up-4 large-up-5">
    ...
    <section class="display-sport" data-token="{{ $token }}" id="sport">
      <div class="row medium-up-2 large-up-4">
  ...
  <div class="row small-up-2 medium-up-4 large-up-5">
    ...
    <section class="display-entertainment" data-token="{{ $token }}" id="entertainment">
      <div class="row medium-up-2 large-up-4">
  ...
  <div class="row small-up-2 medium-up-4 large-up-5">
    ...
    <section class="display-colu" data-token="{{ $token }}" id="colum">
      <div class="row medium-up-2 large-up-4">
  ...
  <div class="row small-up-2 medium-up-4 large-up-5">
    ...
    <section class="display-education" data-token="{{ $token }}" id="education">
      <div class="row medium-up-2 large-up-4">
  ...
  <div class="row small-up-2 medium-up-4 large-up-5">
    ...
    <section class="display-metro" data-token="{{ $token }}" id="metro">
      <div class="row medium-up-2 large-up-4">
  ...
  <div class="row small-up-2 medium-up-4 large-up-5">
    ...
    <section class="display-othernews" data-token="{{ $token }}" id="othernews">
      <div class="row medium-up-2 large-up-4">
