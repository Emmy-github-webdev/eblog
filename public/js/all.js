...
(function () {
    ...
    ACMESTORE.admin.update = function () {
        ...
        $(".update-category").on('click', function (e) {
            ...
            $.ajax({
                type: 'POST',
                url: '/admin/news/categories/' + id + '/edit',
...
(function () {
    ...
    ACMESTORE.home.homePageArticle = function () {
        var app = new Vue({
            ...
            methods: {
                getFeaturedArticle: function getFeaturedArticle() {
                    this.loading = true;
...
(function () {
    ...
    ACMESTORE.home.homeBreakingNews = function () {
        var app = new Vue({
            ...
            methods: {
                getBreakingNews: function getBreakingNews() {
                    this.loading = true;
...
(function () {
    ...
    ACMESTORE.home.homebusiness = function () {
        var app = new Vue({
            ...
            methods: {
                getbusinessArticle: function getbusinessArticle() {
                    this.loading = true;
...
(function () {
    ...
    ACMESTORE.home.homecolumns = function () {
        var app = new Vue({
            ...
            methods: {
                getcolumnsArticle: function getcolumnsArticle() {
                    this.loading = true;
...
(function () {
    ...
    ACMESTORE.home.homeeducation = function () {
        var app = new Vue({
            ...
            methods: {
                geteducationArticle: function geteducationArticle() {
                    this.loading = true;
...
(function () {
    ...
    ACMESTORE.home.homeentertainment = function () {
        var app = new Vue({
            ...
            methods: {
                getentertainmentArticle: function getentertainmentArticle() {
                    this.loading = true;
...
(function () {
    ...
    ACMESTORE.home.homehealth = function () {
        var app = new Vue({
            ...
            methods: {
                gethealthArticle: function gethealthArticle() {
                    this.loading = true;
...
(function () {
    ...
    ACMESTORE.home.homeJustIn = function () {
        var app = new Vue({
            ...
            methods: {
                getjustinArticle: function getjustinArticle() {
                    this.loading = true;
...
(function () {
    ...
    ACMESTORE.home.homemetro = function () {
        var app = new Vue({
            ...
            methods: {
                getmetroArticle: function getmetroArticle() {
                    this.loading = true;
...
(function () {
    ...
    ACMESTORE.home.homeothers = function () {
        var app = new Vue({
            ...
            methods: {
                getothersArticle: function getothersArticle() {
                    this.loading = true;
...
(function () {
    ...
    ACMESTORE.home.homepolitics = function () {
        var app = new Vue({
            ...
            methods: {
                getpoliticsArticle: function getpoliticsArticle() {
                    this.loading = true;
...
(function () {
    ...
    ACMESTORE.home.homerelationship = function () {
        var app = new Vue({
            ...
            methods: {
                getrelationshipArticle: function getrelationshipArticle() {
                    this.loading = true;
...
(function () {
    ...
    ACMESTORE.home.homesport = function () {
        var app = new Vue({
            ...
            methods: {
                getsportArticle: function getsportArticle() {
                    this.loading = true;
...
(function () {
    ...
    ACMESTORE.home.hometechnology = function () {
        var app = new Vue({
            ...
            methods: {
                gettechnologyArticle: function gettechnologyArticle() {
                    this.loading = true;
...
(function () {
    ...
    ACMESTORE.articles.display = function () {
        /*  var app = new Vue({
             el:'#article',
             data: {
                 articles: [],
                 ...
                 loadMoreEndpoint: '/articles/category/load-more'
             },
                   methods: {
                 getArticleCategory: function () {
                     ...
                     var postData = { next: this.next, token: token, count: this.count };
                       if(typeof urlParams !== 'undefined' && urlParams){
                         postData.title = urlParams.title;
